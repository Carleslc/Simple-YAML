...
class YamlFileTest {
    ...
    void fileToString() throws Exception {
        final YamlFile yamlFile = new YamlFile(getResource("test.yml"));
    ...
    void saveToStringWithComments2() throws IOException, InvalidConfigurationException {
        final YamlFile yamlFile = new YamlFile(getResource("test-comments2.yml"));
        yamlFile.loadWithComments();
    ...
    void saveToStringWithComments3() throws IOException, InvalidConfigurationException {
        final YamlFile yamlFile = new YamlFile(getResource("test-comments3.yml"));
        yamlFile.loadWithComments();

        String content = "backup-config:\n" +
                "\n" +
                "  #######################################################################################################################\n" +
                "  # SERVER-FILES BACKUP\n" +
                "  #######################################################################################################################\n" +
    ...
    @Test
    void getFilePath() {
        final File file = new File(getResource("test.yml"));
